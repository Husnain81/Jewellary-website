...
if (isset($_SESSION["username"])) {
    $user_id = $_SESSION["id"];
    $sql = "SELECT tbl_invoices.id, invoice_no, tbl_invoices.order_no, user_id, date, tbl_invoices.status, total_amount
            FROM tbl_invoices
                        ...
                        <tbody>
                            <?php                                
                                while ($row = $result->fetch_assoc()) {
                                        echo "<tr>";
                                        echo "<td> INVO#" . $row['invoice_no'] . "</td>";
                                        echo "<td>" . $row['date'] . "</td>";
                                        echo "<td>" . $row['status'] . "</td>";
                                        echo "<td>" . $row['total_amount'] . "</td>";
                                        echo "<td><a href='invoice-details.php?my-invoice=" . $row['invoice_no'] . "'><i class='fa-solid fa-eye'></i></td>";
                                        echo "</tr>";
